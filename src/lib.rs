...
mod tests {
    ...
    fn test_sha1() {
        ...
        assert_eq!(ret, SIZE_SHA1 as i32);
    }
    ...
    fn test_sha224() {
        ...
        assert_eq!(out_exp, out);
        assert_eq!(ret, SIZE_SHA224 as i32);
    }
    ...
    fn test_sha256() {
        ...
        assert_eq!(out_exp, out);
        assert_eq!(ret, SIZE_SHA256 as i32);
    }
    ...
    fn test_sha384() {
        ...
        assert_eq!(out_exp, out);
        assert_eq!(ret, SIZE_SHA384 as i32);
    }
    ...
    fn test_sha512() {
        ...
        assert_eq!(out_exp, out);
        assert_eq!(ret, SIZE_SHA512 as i32);
    }
